                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 176px;">
                                            <a class="btn btn-outline-info user_list_btn" href="{{($user->department->name == 'Customer')?route('users.show',$user->id):route('staff.show',$user->id)}}">
                                                <i class="bi bi-person-vcard"></i>
                                            </a>
                                            <a class="btn btn-outline-success user_list_btn" href="{{($user->department->name == 'Customer')?route('users.edit',$user->id):route('staff.edit',$user->id)}}">
