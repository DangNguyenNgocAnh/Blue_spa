                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="input-group d-flex justify-content-end">
                                    <div style=" display: flex; ">
                                        <a class="btn btn-info" style="width:40px;height:40px;margin-right: 10px;" href="{{route('users.deleted')}}"><i class="bi bi-trash3"></i></a>
                                        <a class="btn btn-secondary" style="width:40px; height:40px" href="{{route('users.create')}}">+</a>
                                    </div>
                                </div>
                            </div>
                        </div>
