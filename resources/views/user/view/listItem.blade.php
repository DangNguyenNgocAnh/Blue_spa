    ...
    <div class="content">
        ...
        <div class="content-options-static ">
            ...
            <div class="content-options-static-content flex-column1">
                ...
                <div class="content-options-static-content-item mg-bottom">
                    ...
                    <div class="description-package">
                        <div class='description-package-form'>
                            ...
                            <a type="button" class="btn btn-outline-info" data-bs-toggle="modal"
                                data-bs-target="#disablebackdrop{{ $package['id'] }}">
                                <i class="ri-eye-line"></i>
                            </a>
                            <p> {{$package['description']}}</p>
                        </div>
                    </div>
                    <div class="modal fade" id="disablebackdrop{{ $package['id'] }}" tabindex="-1"
