...
<main id="main" class="main" style="margin-left: 0px; background-image: none;">
    ...
    <div class="content">
        ...
        <div class="content-options-static ">
            ...
            <div class="content-options-static-content flex-column1">
                @foreach($coupons as $key=>$coupon)
                <div class="content-options-static-content-item">
                    <img src="{{asset('img/gift-voucher.png')}}" alt="">
                    <div class="content-options-static-content-item-text " style="top: 13px;right: 0px; width:100%; text-align: start; padding-left:10px">
                        ...
                        <a style="font-size:10px" data-bs-toggle="modal" data-bs-target="#confirmModal{{ $coupon['id'] }}">>Mua ngay</a>
                    </div>

                    <!-- Modalconfirm-->
                    <form action="{{route('payments.index',$coupon['id'])}}" method="post">
                        @csrf
                        <div class="modal fade" id="confirmModal{{ $coupon['id'] }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
